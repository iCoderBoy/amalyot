    ...
    if (!isLogin) {
      ...
      try {
        ...
        const userDoc = {
          ...
          image: formData.image, // Rasmni base64 formatda saqlash
        };
        await setDoc(doc(db, 'users', res.user.uid), userDoc); // Foydalanuvchi hujjatini saqlash
        console.log(res.user.uid);
        
        alert('Ro‘yxatdan muvaffaqiyatli o‘tildi!');
        navigate.push("/dashboard"); // Muvaffaqiyatli bo‘lgandan keyin yo‘naltirish
      } catch (error) {
